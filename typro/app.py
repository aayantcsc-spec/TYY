"""
Hybird Application System - Main Application
"""
import time
...
st.set_page_config(
    page_title="Hybird Application System",
    page_icon="🚀",
    layout="wide"
)
...
class ResumeApp:
    def __init__(self):
        ...
        self.pages = {
            ...
            "📄 COVER LETTER GENERATOR": self.render_cover_letter_generator,
            "📝 INTERVIEW PREPARATION": self.render_interview_preparation,
            "🤖 AI MOCK INTERVIEW PRO": self.render_ai_mock_interview,
            "📈 CAREER ROADMAP": self.render_career_roadmap,
            "🧠 CAREER ASSESSMENT": self.render_career_assessment,
            "📚 APTITUDE & PLACEMENT PRACTICE": self.render_aptitude_placement_practice,
            "⏱️ PRODUCTIVITY & HABIT TRACKER": self.render_productivity_habit_tracker,
    ...
    def add_footer(self):
        ...
        with col2:
            ...
            <div style='display: flex; justify-content: center; align-items: center; margin-bottom: 10px;'>
                <a href='https://github.com/SHAIKHAAYAN/Smart-AI-Resume-Analyzer' target='_blank' style='text-decoration: none;'>
    ...
    def render_dashboard(self):
        ...
        st.toast("Check out these repositories: [Awesome Hacking](https://github.com/SHAIKHAAYAN/Awesome-Hacking)", icon="ℹ️")
    ...
    st.session_state.form_data['skills_categories']['tools']),
        ...
        st.toast("Check out these repositories: [30-Days-Of-Rust](https://github.com/SHAIKHAAYAN/30-Days-Of-Rust)", icon="ℹ️")
     ...
     "124852522.jpeg")
        ...
        st.markdown("""
            <div class="hero-section">
                <h1 class="hero-title">About Hybird Application System</h1>
        ...
        st.markdown(f"""
            <div class="profile-section">
                 <img src="{image_base64 if image_base64 else 'https://avatars.githubusercontent.com/SHAIKHAAYAN'}"
                     alt="SHAIKHAAYAN"
                     class="profile-image"
                     onerror="this.onerror=null; this.src='https://avatars.githubusercontent.com/SHAIKHAAYAN';">
                 <h2 class="profile-name">SHAIKHAAYAN</h2>
                <p class="profile-title">Full Stack Developer & AI/ML Enthusiast</p>
                <div class="social-links">
                    <a href="https://github.com/SHAIKHAAYAN" class="social-link" target="_blank">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="https://www.linkedin.com/in/patel-hetkumar-sandipbhai-8b110525a/" class="social-link" target="_blank">
                        <i class="fab fa-linkedin"></i>
                    </a>
                    <a href="mailto:aayan.tcsc@gmail.com" class="social-link" target="_blank">
                        <i class="fas fa-envelope"></i>
                    </a>
                </div>
                <p class="bio-text">
                    Hello! I'm a passionate Full Stack Developer with expertise in AI and Machine Learning.
                    I created Hybird Application System to revolutionize how job seekers approach their career journey.
        ...
        st.markdown("""
            <div class="vision-section">
                ...
                <p class="vision-text">
                    "Hybird Application System represents my vision of democratizing career advancement through technology.
        ...
        st.toast("Check out these repositories: [Iriswise](https://github.com/SHAIKHAAYAN/Iriswise)", icon="ℹ️")
    ...
    "Upload your resume", type=[
        ...
        st.toast("Check out these repositories: [Awesome Java](https://github.com/SHAIKHAAYAN/Awesome-Java)", icon="ℹ️")
    ...
    def render_home(self):
        ...
        st.toast("Check out these repositories: [AI-Nexus(AI/ML)](https://github.com/SHAIKHAAYAN/AI-Nexus)", icon="ℹ️")
    ...
    def render_job_search(self):
        ...
        st.toast("Check out these repositories: [GeeksforGeeks-POTD](https://github.com/SHAIKHAAYAN/GeeksforGeeks-POTD)", icon="ℹ️")
    ...
    def render_feedback_page(self):
        ...
        st.toast("Check out these repositories: [TryHackMe Free Rooms](https://github.com/SHAIKHAAYAN/tryhackme-free-rooms)", icon="ℹ️")
    ...
    def render_cover_letter_generator(self):
        ...
        page_header(
            ...
            "Generate job description-based personalized cover letters"
        )

        st.markdown("""
        - Job description-based personalized cover letter
        - Tone selection (Formal, Confident, Creative)
        - Editable template
        - Download option
        """)
        ...
        col1, col2 = st.columns(2)
        with col1:
            applicant_name = st.text_input("Your Name", value=st.session_state.form_data.get('personal_info', {}).get('full_name', ''))
            job_title = st.text_input("Target Job Title", placeholder="e.g., Data Analyst")
        with col2:
            company_name = st.text_input("Company Name", placeholder="e.g., ABC Technologies")
            tone = st.selectbox("Tone", ["Formal", "Confident", "Creative"])

        job_description = st.text_area("Job Description", height=180, placeholder="Paste the job description here...")

        if st.button("Generate Cover Letter", type="primary"):
            tone_line = {
                "Formal": "I am writing to express my interest in this opportunity and would be honored to contribute to your team.",
                "Confident": "I am excited to apply and confident that my skills and execution mindset can create immediate impact.",
                "Creative": "I thrive on turning complex challenges into meaningful outcomes, and this role is a perfect fit for that energy."
            }.get(tone, "I am excited to apply for this role.")

            generated_letter = f"""Dear Hiring Manager,

My name is {applicant_name or 'Candidate'}, and I am applying for the {job_title or 'position'} role at {company_name or 'your organization'}.

{tone_line}

Based on the job description, I understand the role values:
{job_description[:600] if job_description else '- Strong communication\n- Problem solving\n- Collaboration'}

I believe my background aligns well with your requirements, and I am eager to contribute with ownership, adaptability, and a strong results-driven approach.

Thank you for your time and consideration. I would welcome the opportunity to discuss how I can support your goals.

Sincerely,
{applicant_name or 'Candidate'}
"""
            st.session_state.generated_cover_letter = generated_letter

        cover_letter_text = st.text_area(
            "Editable Cover Letter",
            value=st.session_state.get('generated_cover_letter', ''),
            height=320
        )
    ...
    def render_interview_preparation(self):
        """Render interview preparation page"""
        apply_modern_styles()
        page_header(
            "Interview Preparation",
            "Practice with HR/technical questions and improve interview performance"
        )

        st.markdown("""
        - HR & technical question generator
        ...
        resume_snapshot = st.text_area("Resume Snapshot", height=120, placeholder="Paste highlights from your resume...")
        ...
        if st.button("Generate Interview Questions", type="primary"):
            ...
            technical_questions = [
                f"What core skills are required for a {target_role or 'this role'}?",
                "How do you debug production issues effectively?",
                "Explain a project where you optimized performance.",
                "How do you ensure code quality and maintainability?"
            ]
            resume_based = [
                f"You mentioned '{resume_snapshot[:40]}...'. Can you explain your exact contribution?" if resume_snapshot else "Can you walk me through one impactful project on your resume?",
                "What was the measurable outcome of your work?",
                "What would you improve if you repeated that project today?"
            ]
            ...
            for item in resume_based:
                st.write(f"- {item}")

        st.subheader("STAR Method Training")
        st.info("Use STAR: Situation, Task, Action, Result. Keep answers concise, specific, and measurable.")

        st.subheader("AI Mock Interview Simulation")
        answer_text = st.text_area("Practice Answer", height=140, placeholder="Type your interview answer here...")
        if answer_text:
            filler_words = ["um", "uh", "like", "you know", "basically", "actually"]
            lowered = answer_text.lower()
            filler_count = sum(lowered.count(word) for word in filler_words)
            word_count = max(1, len(answer_text.split()))
            confidence_score = max(0, min(100, int((word_count * 1.5) - (filler_count * 8))))

            st.metric("Confidence Score", f"{confidence_score}/100")
            st.metric("Filler Word Count", filler_count)

    def render_ai_mock_interview(self):
        """Render AI mock interview pro page"""
        apply_modern_styles()
        page_header(
            "AI Mock Interview Pro",
            "Analyze delivery, confidence, and communication quality"
        )
        ...
        st.caption("Use the text transcript and optional recording below to simulate interview analytics.")
        transcript = st.text_area("Speech-to-Text Transcript", height=160, placeholder="Paste or type your spoken response...")

        col1, col2 = st.columns(2)
        with col1:
            eye_contact = st.slider("Eye Contact Score", 0, 100, 70)
        with col2:
            body_language = st.slider("Body Language Score", 0, 100, 72)

        if transcript:
            words = len(transcript.split())
            filler_count = sum(transcript.lower().count(word) for word in ["um", "uh", "like", "you know"])
            clarity_score = max(0, min(100, int((words * 1.2) - (filler_count * 10))))
            confidence_score = int((eye_contact + body_language + clarity_score) / 3)

            st.metric("Clarity Score", f"{clarity_score}/100")
            st.metric("Confidence Score", f"{confidence_score}/100")

        recording = st.file_uploader("Interview Recording Playback", type=["mp3", "wav", "m4a"])
        if recording:
            st.audio(recording)

    def render_career_roadmap(self):
        """Render career roadmap page"""
        apply_modern_styles()
        page_header(
            "Career Roadmap",
            "Plan growth with role progression, skills, salary insights, and demand trends"
        )

        st.markdown("""
        - Role-based career progression path
        ...
        category = st.selectbox("Career Category", list(self.job_roles.keys()))
        roles = list(self.job_roles.get(category, {}).keys())
        role = st.selectbox("Starting Role", roles) if roles else None

        stages = ["Entry", "Mid", "Senior", "Lead"]
        salary_data = pd.DataFrame({
            "Stage": stages,
            "Salary": [6, 12, 20, 32]
        })
        st.subheader("Salary Progression Graph")
        st.line_chart(salary_data.set_index("Stage"))

        st.subheader("Required Skills Per Stage")
        skills_map = {
            "Entry": ["Core fundamentals", "Communication", "Version control"],
            "Mid": ["System design basics", "Testing", "Collaboration"],
            "Senior": ["Architecture", "Mentoring", "Performance tuning"],
            "Lead": ["Strategy", "Stakeholder management", "Execution leadership"]
        }
        for stage in stages:
            st.write(f"**{stage}:** {', '.join(skills_map[stage])}")

        st.subheader("Certification Suggestions")
        st.write("- Google Professional Certificates")
        st.write("- AWS / Azure Fundamentals")
        st.write("- Scrum / Agile Certifications")

        st.subheader("Industry Demand Forecast")
        demand_level = "High" if role else "Moderate"
        st.success(f"Forecast for {role or 'selected path'}: {demand_level} demand over the next 2-3 years.")

    def render_career_assessment(self):
        """Render career assessment page"""
        apply_modern_styles()
        page_header(
            "Career Assessment",
            "Evaluate personality, aptitude, and role suitability"
        )
        ...
        q1 = st.radio("You prefer working style:", ["Independent", "Collaborative", "Balanced"], horizontal=True)
        q2 = st.radio("How do you make decisions?", ["Data-driven", "Intuition-driven", "Mixed"], horizontal=True)

        st.subheader("Aptitude Test")
        a1 = st.slider("Problem-solving confidence", 1, 10, 6)
        a2 = st.slider("Communication confidence", 1, 10, 6)
        a3 = st.slider("Technical confidence", 1, 10, 6)

        if st.button("Calculate Suitability", type="primary"):
            personality_bonus = 5 if q1 == "Balanced" else 3
            decision_bonus = 5 if q2 == "Data-driven" else 3
            aptitude_score = (a1 + a2 + a3) * 3
            suitability = min(100, aptitude_score + personality_bonus + decision_bonus)
            ...
            if a1 >= 7:
                ...
                weaknesses.append("Needs more structured problem-solving practice")
            if a2 >= 7:
                strengths.append("Strong communication")
            else:
                weaknesses.append("Can improve concise communication")
            if a3 >= 7:
                strengths.append("Strong technical foundation")
            else:
                weaknesses.append("Can deepen technical specialization")

            st.metric("Career Suitability Score", f"{suitability}/100")
            st.write("**Strengths:**")
            for item in strengths or ["Developing core strengths"]:
                st.write(f"- {item}")
            st.write("**Weaknesses:**")
            for item in weaknesses or ["No major weaknesses identified"]:
                st.write(f"- {item}")

    def render_productivity_habit_tracker(self):
        """Render productivity and habit tracker page"""
        apply_modern_styles()
        page_header(
            "Productivity & Habit Tracker",
            "Track daily habits, completion progress, and consistency streaks"
        )

        if 'habit_items' not in st.session_state:
            st.session_state.habit_items = ["Deep Work (60 min)", "Exercise", "Reading"]
        if 'habit_logs' not in st.session_state:
            st.session_state.habit_logs = {}

        today = time.strftime("%Y-%m-%d")
        if today not in st.session_state.habit_logs:
            st.session_state.habit_logs[today] = {}

        st.subheader("Add Habit")
        col1, col2 = st.columns([4, 1])
        with col1:
            new_habit = st.text_input("Habit Name", placeholder="e.g., Write journal, Walk 20 mins")
        with col2:
            st.write("")
            st.write("")
            if st.button("Add", use_container_width=True):
                habit = new_habit.strip()
                if habit and habit not in st.session_state.habit_items:
                    st.session_state.habit_items.append(habit)
                    st.rerun()

        st.subheader(f"Today's Checklist ({today})")
        if not st.session_state.habit_items:
            st.info("No habits added yet. Add your first habit above.")
            return

        for habit in list(st.session_state.habit_items):
            current_value = st.session_state.habit_logs.get(today, {}).get(habit, False)
            completed = st.checkbox(habit, value=current_value, key=f"habit_{today}_{habit}")
            st.session_state.habit_logs.setdefault(today, {})[habit] = completed

        done_count = sum(1 for habit in st.session_state.habit_items if st.session_state.habit_logs.get(today, {}).get(habit, False))
        total_count = max(1, len(st.session_state.habit_items))
        completion_pct = int((done_count / total_count) * 100)

        st.subheader("Progress")
        m1, m2 = st.columns(2)
        with m1:
            st.metric("Today's Completion", f"{completion_pct}%")
        with m2:
            st.metric("Habits Completed", f"{done_count}/{len(st.session_state.habit_items)}")
        st.progress(completion_pct / 100)

        st.subheader("Consistency")
        sorted_dates = sorted(st.session_state.habit_logs.keys(), reverse=True)
        streak_days = 0
        for day in sorted_dates:
            day_status = st.session_state.habit_logs.get(day, {})
            if st.session_state.habit_items and all(day_status.get(h, False) for h in st.session_state.habit_items):
                streak_days += 1
            else:
                break
        st.metric("All-Habits Streak", f"{streak_days} day(s)")

        st.subheader("Manage Habits")
        remove_habit = st.selectbox("Remove Habit", ["Select a habit to remove"] + st.session_state.habit_items)
        if st.button("Remove Selected Habit") and remove_habit != "Select a habit to remove":
            st.session_state.habit_items = [h for h in st.session_state.habit_items if h != remove_habit]
            for day in st.session_state.habit_logs:
                st.session_state.habit_logs[day].pop(remove_habit, None)
            st.rerun()

    def _build_aptitude_question_bank(self):
        """Build exactly 300 practice questions across requested sections."""
        section_map = {
            "Aptitude Section": [
                "Arithmetic Aptitude", "Data Interpretation", "Verbal Ability",
                "Logical Reasoning", "Verbal Reasoning", "Non-Verbal Reasoning"
            ],
            "Online Test Series": [
                "Online Tests", "Placement Papers", "Aptitude Exam Practice"
            ],
            "Awareness Section": [
                "Current Affairs", "General Knowledge"
            ],
            "Placement Preparation": [
                "HR Interview", "Group Discussion", "Technical Interview"
            ],
            "Engineering Branch-wise Tests": [
                "Mechanical Engineering", "Civil Engineering", "ECE", "EEE", "CSE"
            ],
            "Programming Section": [
                "C Programming", "C++", "C#", "Java", "Database", "Networking"
            ],
            "Life Sciences Section": [
                "Microbiology", "Biochemistry", "Biotechnology", "Biochemical Engineering"
            ],
            "Fun & Brain Practice": [
                "Puzzles Quiz", "Sudoku", "Brain Teasers"
            ]
        }

        st.session_state.aptitude_section_map = section_map

        seeded_questions = [
            {
                "section": "Aptitude Section",
                "category": "Arithmetic Aptitude",
                "question": "If the ratio of two numbers is 3:5 and their sum is 64, the larger number is:",
                "options": ["24", "40", "48", "60"],
                "answer": "40"
            },
            {
            ...
            {
                "section": "Online Test Series",
                "category": "Online Tests",
            ...
            {
                "section": "Online Test Series",
                "category": "Aptitude Exam Practice",
            ...
            },
            {
                ...
                "question": "In an HR interview, STAR method stands for:",
                "options": [
                    "Situation, Task, Action, Result",
                    "Skill, Talent, Ability, Result",
                    "Situation, Talent, Action, Review",
                    "Strategy, Task, Action, Result"
                ],
                "answer": "Situation, Task, Action, Result"
            },
            {
                "section": "Engineering Branch-wise Tests",
            ...
            {
                "section": "Life Sciences Section",
                "category": "Biochemistry",
                "question": "DNA stands for:",
                "options": ["Deoxyribo Nucleic Acid", "Dynamic Nuclear Acid", "Double Nitrogen Acid", "None"],
            ...
            {
                "section": "Fun & Brain Practice",
                "category": "Puzzles Quiz",
            ...
            },
            {
                ...
                "options": ["214", "2148", "4814", "148"],
                "answer": "214"
            },
            {
                "section": "Fun & Brain Practice",
                "category": "Sudoku",
                "question": "A Sudoku grid has how many rows?",
                "options": ["8", "9", "10", "12"],
                "answer": "9"
            },
            {
                "section": "Fun & Brain Practice",
                "category": "Brain Teasers",
                "question": "Which is a brain teaser?",
                "options": ["Puzzle", "Novel", "Newspaper", "Poem"],
                "answer": "Puzzle"
            }
        ]

        flat_categories = []
        for section, categories in section_map.items():
            for category in categories:
                flat_categories.append((section, category))

        total_questions = 300
        category_count = len(flat_categories)
        base_count = total_questions // category_count
        extra = total_questions % category_count

        target_count = {}
        for idx, pair in enumerate(flat_categories):
            target_count[pair] = base_count + (1 if idx < extra else 0)

        seeded_count_by_category = {}
        for item in seeded_questions:
            key = (item["section"], item["category"])
            seeded_count_by_category[key] = seeded_count_by_category.get(key, 0) + 1
        ...
        def generate_real_mcq(section, category, item_no, category_idx):
            base = item_no + category_idx + 5

            if category == "Arithmetic Aptitude":
                a = 2 + (base % 4)
                b = a + 2
                total = (a + b) * (8 + (base % 5))
                larger = int(total * b / (a + b))
                question = f"If the ratio of two numbers is {a}:{b} and their sum is {total}, the larger number is:"
                options = [str(larger - 6), str(larger), str(larger + 6), str(larger + 12)]
                answer = str(larger)
            ...
            if category == "Data Interpretation":
                ...
                mar = 52 + (base % 9)
                question = (
                    f"A shop sold {jan} units in Jan, {feb} in Feb, and {mar} in Mar. "
                    "Which month has the highest sales?"
                )
                options = ["January", "February", "March", "Cannot be determined"]
                answer = "March"
                return question, options, answer

            if category == "Verbal Ability":
                vocab = [
                    ("Rapid", "Fast", ["Late", "Small", "Quiet"]),
                    ("Ancient", "Old", ["Sharp", "Bright", "Modern"]),
                    ("Abundant", "Plentiful", ["Rare", "Empty", "Rigid"]),
                    ("Candid", "Honest", ["Silent", "Careless", "Noisy"])
                ]
                word, correct, wrong = vocab[base % len(vocab)]
            ...
            if category == "Logical Reasoning":
                ...
                options = [str(next_val - 2), str(next_val), str(next_val + 2), str(next_val + 4)]
                answer = str(next_val)
                return question, options, answer

            if category == "Verbal Reasoning":
                question = "Book is to Reading as Fork is to:"
                options = ["Writing", "Drawing", "Eating", "Running"]
                answer = "Eating"
                return question, options, answer

            if category == "Non-Verbal Reasoning":
                question = "In pattern reasoning, if a shape rotates 90° clockwise each step, total rotation after 3 steps is:"
                options = ["90°", "180°", "270°", "360°"]
                answer = "270°"
                return question, options, answer

            if category in ["Online Tests", "Placement Papers", "Aptitude Exam Practice"]:
                question = "Find the odd one out:"
            ...
            if category == "Current Affairs":
                qbank = [
                    ("Which summit focuses on climate change cooperation?", ["COP", "G20", "BRICS", "SCO"], "COP"),
                    ("Which organization publishes the World Economic Outlook?", ["IMF", "UNESCO", "WHO", "ILO"], "IMF"),
                    ("Which day is globally observed as Earth Day?", ["22 April", "5 June", "1 May", "10 October"], "22 April")
                ]
                return qbank[base % len(qbank)]

            if category == "General Knowledge":
                qbank = [
                    ("What is the capital of Japan?", ["Seoul", "Tokyo", "Kyoto", "Osaka"], "Tokyo"),
                    ("Which planet is called the Red Planet?", ["Venus", "Mars", "Jupiter", "Mercury"], "Mars"),
                    ("Who wrote the Indian national anthem?", ["Tagore", "Nehru", "Premchand", "Subhash Bose"], "Tagore")
                ]
                return qbank[base % len(qbank)]

            if category == "HR Interview":
                question = "What is the best response style when asked about a challenge in HR interviews?"
                options = ["Use STAR format", "Blame teammates", "Avoid details", "Give unrelated story"]
                answer = "Use STAR format"
                return question, options, answer

            if category == "Group Discussion":
                question = "In a group discussion, the most effective behavior is to:"
                options = ["Interrupt others", "Dominate continuously", "Listen and add structured points", "Stay silent"]
                answer = "Listen and add structured points"
                return question, options, answer

            if category == "Technical Interview":
                question = "In technical interviews, the best way to explain an approach is to:"
                options = ["Jump to final answer", "Show assumptions and step-by-step reasoning", "Memorize buzzwords", "Avoid edge cases"]
                answer = "Show assumptions and step-by-step reasoning"
                return question, options, answer
            ...
            if category == "Civil Engineering":
                question = "Which test is commonly used to measure concrete workability?"
                options = ["Slump test", "Brinell test", "Impact test", "Spark test"]
                answer = "Slump test"
                return question, options, answer

            if category == "ECE":
                question = "In digital electronics, NAND gate is known as:"
                options = ["Universal gate", "Linear gate", "Bridge gate", "Passive gate"]
                answer = "Universal gate"
                return question, options, answer

            if category == "EEE":
                question = "The standard frequency of AC supply in India is:"
            ...
            if category == "C Programming":
                ...
                options = ["calloc/malloc", "printf", "scanf", "strlen"]
                answer = "calloc/malloc"
                return question, options, answer

            if category == "C++":
                question = "Which OOP concept allows using the same function name with different parameters in C++?"
                options = ["Inheritance", "Encapsulation", "Polymorphism", "Abstraction"]
                answer = "Polymorphism"
                return question, options, answer

            if category == "C#":
                question = "In C#, which keyword is used to define a class inheritance?"
                options = ["extends", "inherits", ":", "implements"]
                answer = ":"
                return question, options, answer

            if category == "Java":
                question = "Which component of JVM executes bytecode?"
                options = ["JIT/Interpreter", "JDBC", "JAR", "Javadoc"]
            ...
            if category == "Microbiology":
                question = "Which instrument is commonly used to sterilize media in microbiology labs?"
                options = ["Autoclave", "Centrifuge", "Incubator", "Spectrometer"]
                answer = "Autoclave"
                return question, options, answer

            if category == "Biochemistry":
                question = "Proteins are primarily made up of:"
                options = ["Fatty acids", "Amino acids", "Monosaccharides", "Nucleotides"]
                answer = "Amino acids"
                return question, options, answer

            if category == "Biotechnology":
                question = "PCR in biotechnology is used to:"
                options = ["Cut proteins", "Amplify DNA", "Measure pH", "Stain cells"]
                answer = "Amplify DNA"
                return question, options, answer

            if category == "Biochemical Engineering":
                question = "In bioreactor design, pH control is important mainly for:"
                options = ["Cell growth and enzyme activity", "Color improvement", "Reducing foam only", "Noise reduction"]
                answer = "Cell growth and enzyme activity"
                return question, options, answer

            if category == "Puzzles Quiz":
                n = 2 + (base % 6)
                question = f"What comes next in the series: {n}, {n+2}, {n+6}, {n+12}, ?"
                next_val = n + 20
                options = [str(next_val - 2), str(next_val), str(next_val + 2), str(next_val + 4)]
                answer = str(next_val)
                return question, options, answer
            ...
            if category == "Sudoku":
                question = "In a standard Sudoku puzzle, each 3x3 box must contain numbers:"
                options = ["1 to 6", "1 to 8", "1 to 9", "0 to 9"]
                answer = "1 to 9"
                return question, options, answer

            if category == "Brain Teasers":
                question = "A man has 53 socks in a drawer: 21 blue, 15 black, 17 red. Minimum picks to guarantee a matching pair?"
                options = ["2", "3", "4", "5"]
                answer = "4"
                return question, options, answer

            question = f"{category}: Choose the most appropriate option."
            options = ["Option 1", "Option 2", "Option 3", "Option 4"]
            answer = "Option 1"
            return question, options, answer

        for idx, (section, category) in enumerate(flat_categories):
            count_for_category = target_count[(section, category)]
            seeded_here = seeded_count_by_category.get((section, category), 0)
            auto_needed = max(0, count_for_category - seeded_here)

            for i in range(1, auto_needed + 1):
                item_no = seeded_here + i
                question_text, options, answer = generate_real_mcq(section, category, item_no, idx)
                question_bank.append({
                    "id": qid,
                    "section": section,
                    "category": category,
        ...
        return question_bank[:total_questions]

    def render_aptitude_placement_practice(self):
        """Render aptitude and placement practice page."""
        apply_modern_styles()
        page_header(
            "Aptitude & Placement Practice",
            "Comprehensive practice across aptitude, placement, engineering, programming, life sciences, and brain training"
        )

        question_bank = self._build_aptitude_question_bank()
        section_map = st.session_state.aptitude_section_map

        st.success(f"Total Questions Available: {len(question_bank)}")

        with st.expander("View Included Sections"):
            for section, categories in section_map.items():
                st.markdown(f"**{section}**")
                for category in categories:
                    st.write(f"- {category}")

        section_options = ["All Sections"] + list(section_map.keys())
        selected_section = st.selectbox("Select Section", section_options)

        if selected_section == "All Sections":
            available_categories = sorted({q["category"] for q in question_bank})
        else:
            available_categories = section_map[selected_section]
        ...
        if selected_section != "All Sections":
            filtered_questions = [q for q in filtered_questions if q["section"] == selected_section]
        if selected_category != "All Categories":
            filtered_questions = [q for q in filtered_questions if q["category"] == selected_category]

        st.info(f"Filtered Questions: {len(filtered_questions)}")

        show_count = st.slider("Questions to Display", min_value=5, max_value=min(50, max(5, len(filtered_questions))), value=min(10, len(filtered_questions)))

        for q in filtered_questions[:show_count]:
        ...
        st.download_button(
            label="Download 300 Questions (CSV)",
            data=export_df.to_csv(index=False),
            file_name="aptitude_placement_300_questions.csv",
            mime="text/csv"
        )
...
<div style="background-color: #1e1e1e; border-radius: 10px; border: 1px solid #4b6cb7; padding: 10px; margin: 10px 0; color: white;">
    ...
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/SHAIKHAAYAN/tryhackme-free-rooms" target="_blank" style="color: #4CAF50;">TryHackMe Free Rooms</a></li>
        <li><a href="https://github.com/SHAIKHAAYAN/Awesome-Hacking" target="_blank" style="color: #4CAF50;">Awesome Hacking</a></li>
    </ul>
    <div style="margin-bottom: 5px;"><b>Programming Languages:</b></div>
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/SHAIKHAAYAN/Awesome-Java" target="_blank" style="color: #4CAF50;">Awesome Java</a></li>
        <li><a href="https://github.com/SHAIKHAAYAN/30-Days-Of-Rust" target="_blank" style="color: #4CAF50;">30 Days Of Rust</a></li>
    </ul>
    <div style="margin-bottom: 5px;"><b>Data Structures & Algorithms:</b></div>
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/SHAIKHAAYAN/GeeksforGeeks-POTD" target="_blank" style="color: #4CAF50;">GeeksforGeeks POTD</a></li>
        <li><a href="https://github.com/SHAIKHAAYAN/Leetcode-POTD" target="_blank" style="color: #4CAF50;">Leetcode POTD</a></li>
    </ul>
    <div style="margin-bottom: 5px;"><b>AI/ML Projects:</b></div>
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/SHAIKHAAYAN/AI-Nexus" target="_blank" style="color: #4CAF50;">AI Nexus</a></li>
    </ul>
...
"""
    ...
    def main(self):
        ...
        with st.sidebar:
            ...
            st.title("Hybird Application System")
            st.markdown("---")
            
            # Navigation buttons
            for page_name in self.pages.keys():
                if st.button(page_name, use_container_width=True):
                    cleaned_name = page_name.lower().replace(" ", "_").replace("🏠", "").replace("🔍", "").replace("📝", "").replace("📄", "").replace("🤖", "").replace("📈", "").replace("🧠", "").replace("📚", "").replace("⏱️", "").replace("📊", "").replace("🎯", "").replace("💬", "").replace("ℹ️", "").strip()
                    st.session_state.page = cleaned_name
                    st.rerun()
        ...
        page_mapping = {name.lower().replace(" ", "_").replace("🏠", "").replace("🔍", "").replace("📝", "").replace("📄", "").replace("🤖", "").replace("📈", "").replace("🧠", "").replace("📚", "").replace("⏱️", "").replace("📊", "").replace("🎯", "").replace("💬", "").replace("ℹ️", "").strip(): name 
